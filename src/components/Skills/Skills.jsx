...
function Skills() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <label>
      Extra Skills:
        <input type="text" name="skills" value={state.skills} onChange={handleChange} />
      </label>
      <br />
      <label>
      Work Experience:
        <input type="text" name="workExperience" value={state.workExperience} onChange={handleChange} />
      </label>
      <br />
      <label>
      About Me:
        <input type="text" name="aboutMe" value={state.aboutMe} onChange={handleChange} />
      </label>
      <br />
